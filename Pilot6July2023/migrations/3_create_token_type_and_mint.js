module.exports = async ({ getNamedAccounts, deployments, ethers }) => {
    ...
    await pbm.createPBMTokenType("Grab1-sample", 1000000, expiryDate, deployer, "https://gateway.pinata.cloud/ipfs/QmSQedXTQeYskLthumBtD9vh4DFJyrWVfjQXBQTDB9tPCw", "https://gateway.pinata.cloud/ipfs/QmXCGMvSF5VuYmbJMJrngoPAr2pEeeBk7LivccsSxm9qKS" ) ;
    ...
    await pbm.createPBMTokenType("Grab2-sample", 2000000, expiryDate, deployer, "https://gateway.pinata.cloud/ipfs/QmWMM6AfC25Cu2SVJwx8xMmkc9g6aWjoEw1G6u6jFzqd35", "https://gateway.pinata.cloud/ipfs/QmXKQWs6BoGfrooWZWmcF13gu38etP7pabU4x9DegdtNvj" ) ;
    console.log("PBM Token type 2 created") ;
    await new Promise(r => setTimeout(r, 5000)); // UNCOMMENT to prevent rpc rate limiting if you are on free version

    const Spot = await ethers.getContractFactory("Spot");
    const spot = await Spot.attach("0x16e28369bc318636abbf6cb1035da77ffbf4a3bc").connect(deployerSigner); // XSGD deployed on mumbai
