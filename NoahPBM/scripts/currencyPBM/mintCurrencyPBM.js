...
async function main() {
    ...
    const withRealXSGD = false;
    // How much to mint
    const DOLLAR_VALUE_TO_MINT = "1000"; // 0.1 stands for 10 cents, 1.0 stands for 1 dollar
    ...
    const pbmPaymentAddr = (SUBNET_MINT)? "0x8e63Fc22edF4b77e607B779E642bFd5ceF67c278" : "0x8bce8B6BAC1639f2AdB4496389FA2EfBf61BC454";
    const pbmPayment = (await ethers.getContractFactory("CurrencyPBM")).attach(pbmPaymentAddr).connect(deployerSigner);
    ...
    if (SUBNET_MINT) {
        ...
        // stx subnet fake XSGD 0x4B68D02791986Ce280072C558dc56a25b8A1E079
    ...
    const receiverList = [
        ...
        "0x6476D19e528375209E8a529D32e2cBEcF7634EFB", // ali master wallet
    ];
